...
import { QueueOneData, QueueOneDeletion } from '../helpers/graphql_helpers'
import { useNavigate } from 'react-router'



const QueueOne = ({ email }) => {
  const navigate = useNavigate()
  
  const { loading, error, data } = useQuery(QueueOneData, {
    variables: {email},
  })
  ...
  return (
    <div>
      <h1 className='is-size-3'>Important/Urgent</h1>
